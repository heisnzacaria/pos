...
@section('title', 'Print The Bill')
@section('content-header', 'Print The Bill',)
...
<div class="container" id="print">
   {{-- <div class="col-md-12"> --}}
         ...
         <div class="invoice-header">
            <div class="invoice-from">
               ...
               <address class="m-t-5 m-b-5">
                  <strong class="text-inverse">LCDOC, Inc.</strong><br>
                  RABAT<br>
                  City, Zip Code<br>
                  Phone: (212) 456-7890<br>
                  Fax: (212) 456-7890
               </address>
            </div>
            <div class="invoice-to">
               <small>to</small>
               <address class="m-t-5 m-b-5">
                  <strong class="text-inverse">LCDOC</strong><br>
                  Street Address<br>
                  City, Zip Code<br>
            ...
            <div class="invoice-date">
               ...
               <div class="date text-inverse m-t-5"><div></p> {{$order->created_at}}</div>
               ...
               <table class="table table-invoice">
                  <thead>
                     <tr>
                        ...
                        <th class="text-right" width="20%">Custumer Name</th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
                        ...
                        <td class="text-right"> {{$order->getCustomerName()}}</td>
                     </tr>
                     <tr>
                        <td>
    ...
    <br>
      ...
      <a href="javascript:;" onclick="printdiv()" class="btn btn-sm btn-white m-b-10 p-l-5"><i class="fa fa-print t-plus-1 fa-fw fa-lg"></i> Print</a>
